...
export default function App() {
  ...
  const triggerCelebration = (achieverName?: string) => {
    ...
    confetti({
      ...
      spread: 70,
      origin: { y: 0.6 },
      colors: ['#0f172a', '#06b6d4', '#2563eb', '#ffffff']
    });
  ...
  // Derived metrics - Adjusted for combined Hub On volume
  const goal = 150;
      ...
      <header className="glass-header px-4 md:px-8 shrink-0 py-3 relative z-50">
        <div className="max-w-full mx-auto flex justify-between items-center gap-6">
          <div className="flex items-center gap-6">
            <img 
              src="https://i.postimg.cc/htrLVtGV/HUB-ON.png" 
              alt="Hub On - Nogueira Performance" 
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <div className="text-right hidden sm:block relative">
                ...
                <p className="text-[7px] font-bold text-brand-accent uppercase">
                  {stats ? `${stats.total} Agendamentos` : 'Sincronizando...'}
                </p>
              </div>
            </div>
          </div>
          ...
          {error ? (
            ...
            >
              ...
              <aside className="col-span-12 lg:col-span-4 flex flex-col gap-6 overflow-hidden h-full">
                {/* Progress to Goal */}
                <div className="shrink-0 flex flex-col gap-4 items-stretch h-56">
      ...
      <AnimatePresence>
        {recentAchiever && (
          ...
          >
            <motion.div
              animate={{ 
                backgroundColor: ['rgba(15, 23, 42, 0.4)', 'rgba(30, 41, 59, 0.4)', 'rgba(15, 23, 42, 0.4)'],
              }}
            ...
            <motion.div
              ...
              className="bg-brand-blue text-white px-16 py-12 rounded-[4rem] shadow-[0_0_150px_rgba(15,23,42,0.8)] border-8 border-white flex flex-col items-center text-center relative overflow-hidden"
            >
